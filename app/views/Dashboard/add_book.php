  ...
  <form class="card-body" action="/save_book" method="POST" enctype="multipart/form-data">
    ...
    <div class="row g-3">
      <div class="col-md-6">
        ...
        <input name="title" type="text" id="multicol-username" class="form-control" />
      </div>
      <div class="col-md-6">
        <label class="form-label" for="multicol-email">وصف الكتاب</label>
        <div class="input-group input-group-merge">
          <textarea  name="description" type="text"  class="form-control" aria-label="john.doe" aria-describedby="multicol-email2" >
          </textarea>
        </div>
      </div>
      <div class="col-md-6">
        <label class="form-label" for="multicol-username"> عدد الصفحات </label>
        <input name="pages_number" type="text" id="multicol-username" class="form-control" />
      </div>
      <div class="col-md-6">
          <label class="form-label" for="multicol-password">الكمية</label>
          <div class="input-group input-group-merge">
            <input  name="quantity" type="number" id="multicol-password" class="form-control" aria-describedby="multicol-password2" />
      ...
      <div class="col-md-6">
        ...
        <input name="price" type="text" id="multicol-username" class="form-control"  />
      </div>
      <div class="col-md-6">
        <label class="form-label" for="multicol-username">الصيغة</label>
        <input name="format" type="text" id="multicol-username" class="form-control"  />
      </div>
      <div class="col-md-6">
        <label class="form-label" for="multicol-username">الصورة</label>
    ...
    <div class="pt-4">
      ...
      <button type="submit" class="btn btn-primary me-sm-3 me-1">console</button>
